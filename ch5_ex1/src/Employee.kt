...
class Employee : Person {
    ...
    constructor (name: String, reg_ID: Int, emp_id: Int, company: String, department: String, arg: Unit=println("(1) Employee secondary constructor default argument")) : super(name, reg_ID) {
        this.emp_id = emp_id
